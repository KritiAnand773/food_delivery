	...
	if(mysqli_num_rows(mysqli_query($con,$sql))>0){
		...
		if($id==''){
			if($type!='image/jpeg' && $type!='image/png'){
				...
				mysqli_query($con,"insert into dish(category_id,dish,price,dish_detail,status,added_on,image) values('$category_id','$dish','$price','$dish_detail',1,'$added_on','$image')");
				redirect('dish.php');
			}
		}else{
			$image_condition='';
			...
			if($image_error==''){
				$sql="update dish set category_id='$category_id', dish='$dish', price='$price', dish_detail='$dish_detail' $image_condition where id='$id'";
                ...
                <div class="card-body">
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <textarea name="price" class="form-control" placeholder="Dish Detail"><?php echo $dish_detail?></textarea>
                    </div>
                    <div class="form-group">
