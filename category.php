                      ...
                      <tbody>
						...
						<tr>
							...
							<td>
								...
								if($row['status']==1){
								?>
								<a href="?id=<?php echo $row['id']?>&type=deactive"><label class="badge badge-danger"></label></a>
								
								<a href="?id=<?php echo $row['id']?>&type=active"><label class="badge badge-info"></label></a>
								<?php
								}
