...
<!-- <div class="swiper mySwiper" >
  <div class="swiper-wrapper" style="margin-top: 91px;">
    <div class="swiper-slide"><img src="kimages/banner_1.jpg" alt="Slider Image 3"></div>
...
?>
 ...
 <div class="cc1">
   ...
   <form method="post" action="manage_cart.php">
       <div class="card" style="width: 16rem; margin-top: 10px;">
       <img class="card-img-top" src="kimages/bangali_veg_fried_rice.png" alt="Card image cap">
       <div class="card-body">
